...
def forward_flashattn(
    ...
    """
    # 注释掉这个检查，允许在训练过程中的生成阶段使用训练版本的flash attention
...
def _prepare_decoder_attention_mask(
    ...
    # 即使所有值都是True，也不要返回None
    # 原始实现中可能有：if attention_mask is not None and torch.all(attention_mask): return None
    # 但我们需要确保始终返回一个有效的mask
